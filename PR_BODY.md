...
- The latest compiler parent XML remains **#384 (668)** (`IrCompilerTest` 661 + `CodegenModeTest` 7); this measurement adds no compiler XML.
...
- 最新编译器父级 XML 仍为 **#384 (668)**（`IrCompilerTest` 661 + `CodegenModeTest` 7）；本次测量不增加编译器 XML。
