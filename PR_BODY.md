# test: admit extra-local int as first, fourth, and fifth five-arg NEW arguments

## English

Adds fixture-only IR admission coverage for a five-argument
`GregorianCalendar` allocation whose first, fourth, and fifth initializer
