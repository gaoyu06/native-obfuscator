...
- Latest compiler parent XML is **[#452](https://github.com/gaoyu06/native-obfuscator/pull/452) (767)** (`IrCompilerTest` 760 + `CodegenModeTest` 7). This measurement adds no compiler XML.
...
- 最新编译器父级 XML 为 **[#452](https://github.com/gaoyu06/native-obfuscator/pull/452)（767）**（`IrCompilerTest` 760 + `CodegenModeTest` 7）。本次测量不增加编译器 XML。
- Processor changed：**No**。Admitted：**No**。Ship-ready：**No**。
