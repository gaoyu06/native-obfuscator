...
- Remeasures the in-tree IR leftover inventory on post-#275 master at `1699fa2d82aadd04547725de8ae573d04d3684f1`.
- This is **measurement only**. It supersedes #273 on `e1b07a860c3e50ce2ee48c605af069a37a195388`; #270 remains the earlier post-#269 snapshot at `bca314540a4ded96feb2a670d4fac35651bd70fd`, #264 remains the earlier post-#263 snapshot at `c0304febc41f1c665fb42ce0947f38bf0c29947a`, and #207 remains the earlier post-#206 snapshot at `42e52c0076e4a0d3d69be81e47de3c916ca4919e`.
...
- Admission measurement of checked-in fixtures with explicit `--codegen=ir`.
- Not a JDK 17/21/25 support badge.
...
- 在合入 #275 后的 master（`1699fa2d82aadd04547725de8ae573d04d3684f1`）上重新测量仓库内 IR 遗留项清单。
- 本次变更**仅为测量**。它取代 `e1b07a860c3e50ce2ee48c605af069a37a195388` 上的 #273 测量；#270 仍是 `bca314540a4ded96feb2a670d4fac35651bd70fd` 上合入 #269 后的较早快照，#264 仍是 `c0304febc41f1c665fb42ce0947f38bf0c29947a` 上合入 #263 后的较早快照，#207 仍是 `42e52c0076e4a0d3d69be81e47de3c916ca4919e` 上合入 #206 后的较早快照。
