...
JUnit XML totals / JUnit XML 汇总：

- Overall / 总计：339 tests / 测试，0 failures / 失败，0 errors / 错误，
  0 skipped / 跳过。
- `IrCompilerTest`：332 tests / 测试，0 failures / 失败，0 errors / 错误，
  0 skipped / 跳过。
- `CodegenModeTest`：7 tests / 测试，0 failures / 失败，0 errors / 错误，
  0 skipped / 跳过。
