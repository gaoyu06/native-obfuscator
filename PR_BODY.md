...
- Latest compiler parent XML: **[#404](https://github.com/gaoyu06/native-obfuscator/pull/404) (698)** (`IrCompilerTest` 691 + `CodegenModeTest` 7).
...
- 最新编译器父级 XML：**[#404](https://github.com/gaoyu06/native-obfuscator/pull/404)（698）**（`IrCompilerTest` 691 + `CodegenModeTest` 7）。
