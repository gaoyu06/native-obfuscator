...
- Latest compiler parent XML is **[#380](https://github.com/gaoyu06/native-obfuscator/pull/380) (662)** (`IrCompilerTest` 655 + `CodegenModeTest` 7). This measurement adds no compiler XML. The branch was rebased onto leftover-docs #380 (`7fa53f94064172c18e9a96780901e6817f2eb78d`); the measured tree remains leftover-docs #379 `9fa518121ee00310888c9dd752094357e494d27c`.
...
Measurement-only inventory change: processor changed **No**; admitted **No**. Measurement commit `9fa518121ee00310888c9dd752094357e494d27c` matches leftover-docs #379. After rebase the merge-base is leftover-docs #380 `7fa53f94064172c18e9a96780901e6817f2eb78d`. This branch only changes `docs/benchmarks/ir-leftover-inventory.md` plus scratch `PR_BODY.md`. Parent skipped Gradle (measurement-only).
...
- 最新编译器父级 XML 为 **[#380](https://github.com/gaoyu06/native-obfuscator/pull/380)（662）**（`IrCompilerTest` 655 + `CodegenModeTest` 7）；本次测量不增加编译器 XML。分支已 rebase 到 leftover-docs #380（`7fa53f94064172c18e9a96780901e6817f2eb78d`）；实测树仍为 leftover-docs #379 `9fa518121ee00310888c9dd752094357e494d27c`。
...
本次仅为 inventory 测量：处理器变更为**否**；接纳变更为**否**。测量提交 `9fa518121ee00310888c9dd752094357e494d27c` 与 leftover-docs #379 一致；rebase 后 merge-base 为 leftover-docs #380 `7fa53f94064172c18e9a96780901e6817f2eb78d`。此分支只改 `docs/benchmarks/ir-leftover-inventory.md` 和草稿 `PR_BODY.md`。父任务跳过 Gradle（仅测量）。
