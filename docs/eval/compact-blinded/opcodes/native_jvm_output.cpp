...
namespace native_jvm {
    ...
    void prepare_lib(JNIEnv *env) {
        ...
        env->DeleteLocalRef(env->DefineClass(((char *)(string_pool + 105LL)), nullptr, native_jvm::data::__ngen_data_native0_hidden_Hidden0::get_class_data(), native_jvm::data::__ngen_data_native0_hidden_Hidden0::get_class_data_length()));
