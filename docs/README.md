...
| [architecture/project-status.md](architecture/project-status.md) | EN + 中文 | What is on `master` after #118–#200. Claims that are **not** allowed. |
...
| [architecture/ir-flex-ctor-status.md](architecture/ir-flex-ctor-status.md) | Constructor split through hybrid suffixes, leaf-only `IDIV`/`IREM` chain inputs, and proven multi-super catch tables (#146/#160/#163–#166/#170–#200) |
