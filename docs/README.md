...
| [architecture/project-status.md](architecture/project-status.md) | EN + 中文 | What is on `master` after #118–#206. Claims that are **not** allowed. |
...
| [architecture/ir-flex-ctor-status.md](architecture/ir-flex-ctor-status.md) | Constructor split through hybrid suffixes, relocated distinct-suffix handlers, receiver-alias forwarding, and identical-copy extras (#146/#160/#163–#166/#170–#206) |
...
| [benchmarks/ir-leftover-inventory.md](benchmarks/ir-leftover-inventory.md) | Post-#198 admission inventory (#199; ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21). Not coverage-complete |
