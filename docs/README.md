...
| [architecture/project-status.md](architecture/project-status.md) | EN + 中文 | What is on `master` after #118–#198. Claims that are **not** allowed. |
...
| [architecture/ir-flex-ctor-status.md](architecture/ir-flex-ctor-status.md) | Constructor split through hybrid suffixes and leaf-only `IDIV`/`IREM` chain inputs (#146/#160/#163–#166/#170–#198) |
