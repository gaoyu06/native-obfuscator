...
| [architecture/project-status.md](architecture/project-status.md) | EN + 中文 | What is on `master` after #118–#275. Claims that are **not** allowed. |
...
| [benchmarks/ir-leftover-inventory.md](benchmarks/ir-leftover-inventory.md) | Post-#272 admission inventory (#273; ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21). Not coverage-complete |
