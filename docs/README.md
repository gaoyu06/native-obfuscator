...
| [architecture/project-status.md](architecture/project-status.md) | EN + 中文 | What is on `master` after #118–#209. Claims that are **not** allowed. |
...
| [architecture/ir-flex-ctor-status.md](architecture/ir-flex-ctor-status.md) | Constructor split through hybrid suffixes, relocated and method-end handlers, receiver-alias forwarding, and identical-copy extras/catch (#146/#160/#163–#166/#170–#209) |
