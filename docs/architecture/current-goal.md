...
1. **Fill IR admission gaps** (current work). Known leftovers on
   `master` after #373 (extra-local int as the first and fifth five-arg GregorianCalendar NEW args)
