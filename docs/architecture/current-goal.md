...
1. **Fill IR admission gaps** (current work). Known leftovers on
   `master` after #375 (extra-local int as the second and third five-arg GregorianCalendar NEW args)
