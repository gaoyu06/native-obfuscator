...
1. **Fill IR admission gaps** (current work). Known leftovers on
   `master` after #379 (extra-local int as the second and fifth five-arg GregorianCalendar NEW args)
