...
1. **Fill IR admission gaps** (current work). Known leftovers on
   `master` after #455 (extra-local int as the fourth and sixth six-arg GregorianCalendar NEW args)
