...
1. **Fill IR admission gaps** (current work). Known leftovers on
   `master` after #452 (extra-local int as the third and sixth six-arg GregorianCalendar NEW args)
