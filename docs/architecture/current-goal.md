...
1. **Fill IR admission gaps** (current work). Known leftovers on
   `master` after #442 (extra-local int as the second and fourth six-arg GregorianCalendar NEW args)
   ...
   admission (#441 measurement on leftover-docs #440 `ef6884ed`) observed no
   leftover methods; that is not a complete JVM inventory. #440 remains
