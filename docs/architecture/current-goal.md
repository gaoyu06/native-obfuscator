...
1. **Fill IR admission gaps** (current work). Known leftovers on
   `master` after #362 (extra-local int as the fourth five-arg GregorianCalendar NEW arg)
   ...
   admission (#361 measurement on post-#360 `7feb4c0`) observed no
   leftover methods; that is not a complete JVM inventory. #359 remains
