...
1. **Fill IR admission gaps** (current work). Known leftovers on
   `master` after #370 (extra-local int as the first and third five-arg GregorianCalendar NEW args)
