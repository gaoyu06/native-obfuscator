...
1. **Fill IR admission gaps** (current work). Known leftovers on
   `master` after #377 (extra-local int as the second and fourth five-arg GregorianCalendar NEW args)
