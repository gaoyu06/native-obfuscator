...
1. **Fill IR admission gaps** (current work). Known leftovers on
   `master` after #372 (extra-local int as the first and fourth five-arg GregorianCalendar NEW args)
