...
1. **Fill IR admission gaps** (current work). Known leftovers on
   `master` after #368 (extra-local int as the first and second five-arg GregorianCalendar NEW args)
