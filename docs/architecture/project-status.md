...
Latest compiler parent XML remains #336 (593). Active process:
...
- **(a) Scope / 范围:** Status refresh after leftover inventory remasurement #337. /
  leftover inventory 重测 #337 之后的现状刷新。
