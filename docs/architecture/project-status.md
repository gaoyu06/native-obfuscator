...
Latest compiler parent XML remains #332 (587). Active process:
...
- **(a) Scope / 范围:** Status refresh after leftover inventory remasurement #333. /
  leftover inventory 重测 #333 之后的现状刷新。
