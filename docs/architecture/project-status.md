...
(measurement only on post-[#294](https://github.com/gaoyu06/native-obfuscator/pull/294)
...
- **(a) Scope / 范围:** Status refresh after landing #295
  (leftover inventory remasurement on post-#294 master). /
  落地 #295 之后的现状刷新。
