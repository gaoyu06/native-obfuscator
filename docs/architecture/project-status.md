...
Last updated after extra-local int as first and second Insets `NEW` args
[#338](https://github.com/gaoyu06/native-obfuscator/pull/338)
(parent XML 596; latest leftover inventory remains
[#337](https://github.com/gaoyu06/native-obfuscator/pull/337)
on post-[#336](https://github.com/gaoyu06/native-obfuscator/pull/336)
`d5faac9`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR,
...
- Admit remaining IR leftovers so methods stop falling back:
  ...
  ([#337](https://github.com/gaoyu06/native-obfuscator/pull/337),
  measured on post-#336 `d5faac9`) observed 0 leftovers; that is not
  coverage-complete. #335 remains the earlier post-#334 snapshot.
...
- **(a) Scope / 范围:** Status refresh after landing #338
  (extra-local int-copy as the first and second Insets NEW initializer arguments). /
  落地 #338 之后的现状刷新。
