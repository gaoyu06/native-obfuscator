...
Last updated after extra-local double as second `NEW` initializer
[#312](https://github.com/gaoyu06/native-obfuscator/pull/312)
(parent XML 551; latest leftover inventory remains
...
- Admit remaining IR leftovers so methods stop falling back:
  ...
  argument is admitted by #312 (fixture-only).
...
- **(a) Scope / 范围:** Status refresh after landing #312
  (extra-local double-copy as the second NEW initializer). /
  落地 #312 之后的现状刷新。
