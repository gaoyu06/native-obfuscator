...
Last updated after extra-local int as the first, third, and fourth five-arg GregorianCalendar `NEW` args
[#392](https://github.com/gaoyu06/native-obfuscator/pull/392)
(parent XML 680; latest leftover inventory remains
...
- **(a) Scope / 范围:** Status refresh after landing #392
  (extra-local int-copy as the first, third, and fourth five-arg GregorianCalendar NEW initializer arguments). /
  落地 #392 之后的现状刷新。
