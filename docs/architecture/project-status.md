...
Last updated after extra-local int as the second and fourth six-arg GregorianCalendar `NEW` args
[#442](https://github.com/gaoyu06/native-obfuscator/pull/442)
(parent XML 752; latest leftover inventory remains
[#441](https://github.com/gaoyu06/native-obfuscator/pull/441)
on leftover-docs
[#440](https://github.com/gaoyu06/native-obfuscator/pull/440)
`ef6884ed`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR,
...
- Admit remaining IR leftovers so methods stop falling back:
  ...
  ([#441](https://github.com/gaoyu06/native-obfuscator/pull/441),
  measured on leftover-docs #440 `ef6884ed`) observed 0 leftovers; that is not
  coverage-complete. #440 remains the earlier leftover-docs #438 snapshot.
...
- **(a) Scope / 范围:** Status refresh after landing #442
  (extra-local int-copy as the second and fourth six-arg GregorianCalendar NEW initializer arguments). /
  落地 #442 之后的现状刷新。
