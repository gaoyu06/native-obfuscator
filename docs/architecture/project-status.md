...
(measurement only on post-[#304](https://github.com/gaoyu06/native-obfuscator/pull/304)
...
- **(a) Scope / 范围:** Status refresh after landing #306
  (post-#304 leftover inventory remasurement). /
  落地 #306 之后的现状刷新。
