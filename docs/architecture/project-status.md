...
(measurement only on post-[#296](https://github.com/gaoyu06/native-obfuscator/pull/296)
...
- **(a) Scope / 范围:** Status refresh after landing #297
  (leftover inventory remasurement on post-#296 master). /
  落地 #297 之后的现状刷新。
