...
Last updated after extra-local int as the first, second, third, and fourth five-arg GregorianCalendar `NEW` args
[#406](https://github.com/gaoyu06/native-obfuscator/pull/406)
(parent XML 701; latest leftover inventory remains
[#405](https://github.com/gaoyu06/native-obfuscator/pull/405)
on leftover-docs
[#403](https://github.com/gaoyu06/native-obfuscator/pull/403)
`a760bc0d`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR,
...
- Admit remaining IR leftovers so methods stop falling back:
  ...
  ([#405](https://github.com/gaoyu06/native-obfuscator/pull/405),
  measured on leftover-docs #403 `a760bc0d`) observed 0 leftovers; that is not
  coverage-complete. #403 remains the earlier leftover-docs #401 snapshot.
...
- **(a) Scope / 范围:** Status refresh after landing #406
  (extra-local int-copy as the first, second, third, and fourth five-arg GregorianCalendar NEW initializer arguments). /
  落地 #406 之后的现状刷新。
