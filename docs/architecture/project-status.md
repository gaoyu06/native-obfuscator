...
Last updated after extra-local int as the first and second six-arg GregorianCalendar `NEW` args
[#430](https://github.com/gaoyu06/native-obfuscator/pull/430)
(parent XML 734; latest leftover inventory remains
[#429](https://github.com/gaoyu06/native-obfuscator/pull/429)
on leftover-docs
[#427](https://github.com/gaoyu06/native-obfuscator/pull/427)
`96de67dd`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR,
...
- Admit remaining IR leftovers so methods stop falling back:
  ...
  ([#429](https://github.com/gaoyu06/native-obfuscator/pull/429),
  measured on leftover-docs #427 `96de67dd`) observed 0 leftovers; that is not
  coverage-complete. #427 remains the earlier leftover-docs #425 snapshot.
...
- **(a) Scope / 范围:** Status refresh after landing #430
  (extra-local int-copy as the first and second six-arg GregorianCalendar NEW initializer arguments). /
  落地 #430 之后的现状刷新。
