...
Last updated after extra-local int as second and third Color `NEW` args
[#328](https://github.com/gaoyu06/native-obfuscator/pull/328)
(parent XML 581; latest leftover inventory remains
[#327](https://github.com/gaoyu06/native-obfuscator/pull/327)
on post-[#326](https://github.com/gaoyu06/native-obfuscator/pull/326)
`0894b16`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR,
...
- Admit remaining IR leftovers so methods stop falling back:
  ...
  ([#327](https://github.com/gaoyu06/native-obfuscator/pull/327),
  measured on post-#326 `0894b16`) observed 0 leftovers; that is not
  coverage-complete. #325 remains the earlier post-#324 snapshot.
...
- **(a) Scope / 范围:** Status refresh after landing #328
  (extra-local int-copy as second and third Color NEW initializer arguments). /
  落地 #328 之后的现状刷新。
