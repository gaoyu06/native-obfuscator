...
Latest compiler parent XML remains #326 (578). Active process:
...
- **(a) Scope / 范围:** Status refresh after leftover inventory remasurement #327. /
  leftover inventory 重测 #327 之后的现状刷新。
