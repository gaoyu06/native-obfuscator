...
Last updated after extra-local int as the fifth and sixth six-arg GregorianCalendar `NEW` args
[#456](https://github.com/gaoyu06/native-obfuscator/pull/456)
(parent XML 776; latest leftover inventory remains
[#454](https://github.com/gaoyu06/native-obfuscator/pull/454)
on leftover-docs
[#452](https://github.com/gaoyu06/native-obfuscator/pull/452)
`a6896796`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR,
...
| Extra-local int as the first, third, and fourth five-arg GregorianCalendar `NEW` args (#392) | 680 tests (`IrCompilerTest` 673 + `CodegenModeTest` 7). Parent re-ran 680/680 including `threeImmediateNewExtraLocalFiveFirstThirdFourthArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Post-#391 leftover inventory (#393) | Measurement only on `51d6aed`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
| Extra-local int as the first, third, and fifth five-arg GregorianCalendar `NEW` args (#394) | 683 tests (`IrCompilerTest` 676 + `CodegenModeTest` 7). Parent re-ran 683/683 including `threeImmediateNewExtraLocalFiveFirstThirdFifthArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Post-#393 leftover inventory (#395) | Measurement only on `051d283`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
| Extra-local int as the first, fourth, and fifth five-arg GregorianCalendar `NEW` args (#396) | 686 tests (`IrCompilerTest` 679 + `CodegenModeTest` 7). Parent re-ran 686/686 including `threeImmediateNewExtraLocalFiveFirstFourthFifthArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Post-#395 leftover inventory (#397) | Measurement only on `38c8cf0`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
| Extra-local int as the second, third, and fourth five-arg GregorianCalendar `NEW` args (#398) | 689 tests (`IrCompilerTest` 682 + `CodegenModeTest` 7). Parent re-ran 689/689 including `threeImmediateNewExtraLocalFiveSecondThirdFourthArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Post-#397 leftover inventory (#399) | Measurement only on `9675616`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
| Extra-local int as the second, third, and fifth five-arg GregorianCalendar `NEW` args (#400) | 692 tests (`IrCompilerTest` 685 + `CodegenModeTest` 7). Parent re-ran 692/692 including `threeImmediateNewExtraLocalFiveSecondThirdFifthArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Post-#399 leftover inventory (#401) | Measurement only on `454af268`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
| Extra-local int as the second, fourth, and fifth five-arg GregorianCalendar `NEW` args (#402) | 695 tests (`IrCompilerTest` 688 + `CodegenModeTest` 7). Parent re-ran 695/695 including `threeImmediateNewExtraLocalFiveSecondFourthFifthArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Post-#401 leftover inventory (#403) | Measurement only on `2b94f0b6`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
| Extra-local int as the third, fourth, and fifth five-arg GregorianCalendar `NEW` args (#404) | 698 tests (`IrCompilerTest` 691 + `CodegenModeTest` 7). Parent re-ran 698/698 including `threeImmediateNewExtraLocalFiveThirdFourthFifthArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Post-#403 leftover inventory (#405) | Measurement only on `a760bc0d`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
...
| Post-#413 leftover inventory (#414) | Measurement only on `bb97bc39`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
| Extra-local int as the second, third, fourth, and fifth five-arg GregorianCalendar `NEW` args (#415) | 713 tests (`IrCompilerTest` 706 + `CodegenModeTest` 7). Parent re-ran 713/713 including `threeImmediateNewExtraLocalFiveSecondThirdFourthFifthArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Post-#415 leftover inventory (#416) | Measurement only on `621d39be`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
| Extra-local int as the second six-arg GregorianCalendar `NEW` args (#417) | 716 tests (`IrCompilerTest` 709 + `CodegenModeTest` 7). Parent re-ran 716/716 including `threeImmediateNewExtraLocalSixSecondArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Post-#417 leftover inventory (#418) | Measurement only on `fcff55af`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
| Extra-local int as the third six-arg GregorianCalendar `NEW` args (#419) | 719 tests (`IrCompilerTest` 712 + `CodegenModeTest` 7). Parent re-ran 719/719 including `threeImmediateNewExtraLocalSixThirdArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Post-#419 leftover inventory (#420) | Measurement only on `82ee119a`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
| Extra-local int as the fourth six-arg GregorianCalendar `NEW` args (#421) | 722 tests (`IrCompilerTest` 715 + `CodegenModeTest` 7). Parent re-ran 722/722 including `threeImmediateNewExtraLocalSixFourthArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Post-#421 leftover inventory (#422) | Measurement only on `d13e6039`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
| Extra-local int as the fifth six-arg GregorianCalendar `NEW` args (#423) | 725 tests (`IrCompilerTest` 718 + `CodegenModeTest` 7). Parent re-ran 725/725 including `threeImmediateNewExtraLocalSixFifthArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Post-#423 leftover inventory (#424) | Measurement only on `9a45cc67`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
| Extra-local int as the sixth six-arg GregorianCalendar `NEW` args (#425) | 728 tests (`IrCompilerTest` 721 + `CodegenModeTest` 7). Parent re-ran 728/728 including `threeImmediateNewExtraLocalSixSixthArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Post-#425 leftover inventory (#426) | Measurement only on `a54d9a28`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
| Extra-local int as all six six-arg GregorianCalendar `NEW` args (#427) | 731 tests (`IrCompilerTest` 724 + `CodegenModeTest` 7). Parent re-ran 731/731 including `threeImmediateNewExtraLocalSixAllArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Post-#427 leftover inventory (#429) | Measurement only on `96de67dd`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
| Extra-local int as the first and second six-arg GregorianCalendar `NEW` args (#430) | 734 tests (`IrCompilerTest` 727 + `CodegenModeTest` 7). Parent re-ran 734/734 including `threeImmediateNewExtraLocalSixFirstSecondArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Post-#430 leftover inventory (#431) | Measurement only on `46a53713`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
| Extra-local int as the first and third six-arg GregorianCalendar `NEW` args (#432) | 737 tests (`IrCompilerTest` 730 + `CodegenModeTest` 7). Parent re-ran 737/737 including `threeImmediateNewExtraLocalSixFirstThirdArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Post-#432 leftover inventory (#433) | Measurement only on `ce634292`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
| Extra-local int as the first and fourth six-arg GregorianCalendar `NEW` args (#434) | 740 tests (`IrCompilerTest` 733 + `CodegenModeTest` 7). Parent re-ran 740/740 including `threeImmediateNewExtraLocalSixFirstFourthArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Post-#434 leftover inventory (#435) | Measurement only on `3645eb36`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
| Extra-local int as the first and fifth six-arg GregorianCalendar `NEW` args (#436) | 743 tests (`IrCompilerTest` 736 + `CodegenModeTest` 7). Parent re-ran 743/743 including `threeImmediateNewExtraLocalSixFirstFifthArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Post-#436 leftover inventory (#437) | Measurement only on `4fed275e`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
| Extra-local int as the first and sixth six-arg GregorianCalendar `NEW` args (#438) | 746 tests (`IrCompilerTest` 739 + `CodegenModeTest` 7). Parent re-ran 746/746 including `threeImmediateNewExtraLocalSixFirstSixthArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Post-#438 leftover inventory (#439) | Measurement only on `a158191a`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
| Extra-local int as the second and third six-arg GregorianCalendar `NEW` args (#440) | 749 tests (`IrCompilerTest` 742 + `CodegenModeTest` 7). Parent re-ran 749/749 including `threeImmediateNewExtraLocalSixSecondThirdArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Post-#440 leftover inventory (#441) | Measurement only on `ef6884ed`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
| Extra-local int as the second and fourth six-arg GregorianCalendar `NEW` args (#442) | 752 tests (`IrCompilerTest` 745 + `CodegenModeTest` 7). Parent re-ran 752/752 including `threeImmediateNewExtraLocalSixSecondFourthArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Post-#442 leftover inventory (#443) | Measurement only on `8d324696`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
| Extra-local int as the second and fifth six-arg GregorianCalendar `NEW` args (#444) | 755 tests (`IrCompilerTest` 748 + `CodegenModeTest` 7). Parent re-ran 755/755 including `threeImmediateNewExtraLocalSixSecondFifthArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Post-#444 leftover inventory (#445) | Measurement only on `c89015d2`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
| Extra-local int as the second and sixth six-arg GregorianCalendar `NEW` args (#446) | 758 tests (`IrCompilerTest` 751 + `CodegenModeTest` 7). Parent re-ran 758/758 including `threeImmediateNewExtraLocalSixSecondSixthArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Post-#446 leftover inventory (#447) | Measurement only on `7e95adc3`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
| Extra-local int as the third and fourth six-arg GregorianCalendar `NEW` args (#448) | 761 tests (`IrCompilerTest` 754 + `CodegenModeTest` 7). Parent re-ran 761/761 including `threeImmediateNewExtraLocalSixThirdFourthArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Post-#448 leftover inventory (#449) | Measurement only on `9a95f300`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
| Extra-local int as the third and fifth six-arg GregorianCalendar `NEW` args (#450) | 764 tests (`IrCompilerTest` 757 + `CodegenModeTest` 7). Parent re-ran 764/764 including `threeImmediateNewExtraLocalSixThirdFifthArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Post-#450 leftover inventory (#451) | Measurement only on `4ca8cfd2`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
| Extra-local int as the third and sixth six-arg GregorianCalendar `NEW` args (#452) | 767 tests (`IrCompilerTest` 760 + `CodegenModeTest` 7). Parent re-ran 767/767 including `threeImmediateNewExtraLocalSixThirdSixthArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Extra-local int as the fourth and fifth six-arg GregorianCalendar `NEW` args (#453) | 770 tests (`IrCompilerTest` 763 + `CodegenModeTest` 7). Parent re-ran 770/770 including `threeImmediateNewExtraLocalSixFourthFifthArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Post-#452 leftover inventory (#454) | Measurement only on `a6896796`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR. 0 leftovers | Not coverage-complete; not a JDK support badge |
| Extra-local int as the fourth and sixth six-arg GregorianCalendar `NEW` args (#455) | 773 tests (`IrCompilerTest` 766 + `CodegenModeTest` 7). Parent re-ran 773/773 including `threeImmediateNewExtraLocalSixFourthSixthArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
| Extra-local int as the fifth and sixth six-arg GregorianCalendar `NEW` args (#456) | 776 tests (`IrCompilerTest` 769 + `CodegenModeTest` 7). Parent re-ran 776/776 including `threeImmediateNewExtraLocalSixFifthSixthArgChainInputsCompileAndRunWithJavaParity` | Remaining ctor-split rejects are gone |
...
- Admit remaining IR leftovers so methods stop falling back:
  ...
  Extra-local proven int-copy as the first, third, and fourth five-arg GregorianCalendar `NEW`
  initializer arguments is admitted by #392 (fixture-only).
  Extra-local proven int-copy as the first, third, and fifth five-arg GregorianCalendar `NEW`
  initializer arguments is admitted by #394 (fixture-only).
  Extra-local proven int-copy as the first, fourth, and fifth five-arg GregorianCalendar `NEW`
  initializer arguments is admitted by #396 (fixture-only).
  Extra-local proven int-copy as the second, third, and fourth five-arg GregorianCalendar `NEW`
  initializer arguments is admitted by #398 (fixture-only).
  Extra-local proven int-copy as the second, third, and fifth five-arg GregorianCalendar `NEW`
  initializer arguments is admitted by #400 (fixture-only).
  Extra-local proven int-copy as the second, fourth, and fifth five-arg GregorianCalendar `NEW`
  initializer arguments is admitted by #402 (fixture-only).
  Extra-local proven int-copy as the third, fourth, and fifth five-arg GregorianCalendar `NEW`
  initializer arguments is admitted by #404 (fixture-only).
  Extra-local proven int-copy as the first, second, third, and fourth five-arg GregorianCalendar `NEW`
  initializer arguments is admitted by #406 (fixture-only).
  Extra-local proven int-copy as the first, second, third, and fifth five-arg GregorianCalendar `NEW`
  ...
  Extra-local proven int-copy as the second, third, fourth, and fifth five-arg GregorianCalendar `NEW`
  initializer arguments is admitted by #415 (fixture-only).
  Extra-local proven int-copy as the second six-arg GregorianCalendar `NEW`
  initializer argument is admitted by #417 (fixture-only).
  Extra-local proven int-copy as the third six-arg GregorianCalendar `NEW`
  initializer argument is admitted by #419 (fixture-only).
  Extra-local proven int-copy as the fourth six-arg GregorianCalendar `NEW`
  initializer argument is admitted by #421 (fixture-only).
  Extra-local proven int-copy as the fifth six-arg GregorianCalendar `NEW`
  initializer argument is admitted by #423 (fixture-only).
  Extra-local proven int-copy as the sixth six-arg GregorianCalendar `NEW`
  initializer argument is admitted by #425 (fixture-only).
  Extra-local proven int-copy as all six six-arg GregorianCalendar `NEW`
  initializer arguments is admitted by #427 (fixture-only).
  Extra-local proven int-copy as the first and second six-arg GregorianCalendar `NEW`
  initializer arguments is admitted by #430 (fixture-only).
  Extra-local proven int-copy as the first and third six-arg GregorianCalendar `NEW`
  initializer arguments is admitted by #432 (fixture-only).
  Extra-local proven int-copy as the first and fourth six-arg GregorianCalendar `NEW`
  initializer arguments is admitted by #434 (fixture-only).
  Extra-local proven int-copy as the first and fifth six-arg GregorianCalendar `NEW`
  initializer arguments is admitted by #436 (fixture-only).
  Extra-local proven int-copy as the first and sixth six-arg GregorianCalendar `NEW`
  initializer arguments is admitted by #438 (fixture-only).
  Extra-local proven int-copy as the second and third six-arg GregorianCalendar `NEW`
  initializer arguments is admitted by #440 (fixture-only).
  Extra-local proven int-copy as the second and fourth six-arg GregorianCalendar `NEW`
  initializer arguments is admitted by #442 (fixture-only).
  Extra-local proven int-copy as the second and fifth six-arg GregorianCalendar `NEW`
  initializer arguments is admitted by #444 (fixture-only).
  Extra-local proven int-copy as the second and sixth six-arg GregorianCalendar `NEW`
  initializer arguments is admitted by #446 (fixture-only).
  Extra-local proven int-copy as the third and fourth six-arg GregorianCalendar `NEW`
  initializer arguments is admitted by #448 (fixture-only).
  Extra-local proven int-copy as the third and fifth six-arg GregorianCalendar `NEW`
  initializer arguments is admitted by #450 (fixture-only).
  Extra-local proven int-copy as the third and sixth six-arg GregorianCalendar `NEW`
  initializer arguments is admitted by #452 (fixture-only).
  Extra-local proven int-copy as the fourth and fifth six-arg GregorianCalendar `NEW`
  initializer arguments is admitted by #453 (fixture-only).
  Extra-local proven int-copy as the fourth and sixth six-arg GregorianCalendar `NEW`
  initializer arguments is admitted by #455 (fixture-only).
  Extra-local proven int-copy as the fifth and sixth six-arg GregorianCalendar `NEW`
  initializer arguments is admitted by #456 (fixture-only).
  ...
  ([#454](https://github.com/gaoyu06/native-obfuscator/pull/454),
  measured on leftover-docs #452 `a6896796`) observed 0 leftovers; that is not
  coverage-complete. #452 remains the earlier leftover-docs #450 snapshot.
  #450 remains the earlier leftover-docs #448 snapshot.
  #448 remains the earlier leftover-docs #446 snapshot.
  #446 remains the earlier leftover-docs #444 snapshot.
  #444 remains the earlier leftover-docs #442 snapshot.
  #442 remains the earlier leftover-docs #440 snapshot.
  #440 remains the earlier leftover-docs #438 snapshot.
  #438 remains the earlier leftover-docs #436 snapshot.
  #436 remains the earlier leftover-docs #434 snapshot.
  #434 remains the earlier leftover-docs #432 snapshot.
  #432 remains the earlier leftover-docs #430 snapshot.
  #430 remains the earlier leftover-docs #427 snapshot.
  #427 remains the earlier leftover-docs #425 snapshot.
  #425 remains the earlier leftover-docs #423 snapshot.
  #423 remains the earlier leftover-docs #421 snapshot.
  #421 remains the earlier leftover-docs #419 snapshot.
  #419 remains the earlier leftover-docs #417 snapshot.
  #417 remains the earlier leftover-docs #415 snapshot.
  #415 remains the earlier leftover-docs #413 snapshot.
  #413 remains the earlier leftover-docs #411 snapshot.
  #411 remains the earlier leftover-docs #409 snapshot.
  #409 remains the earlier leftover-docs #407 snapshot.
  #407 remains the earlier leftover-docs #405 snapshot.
  ...
  #397 remains the earlier leftover-docs #395 snapshot.
  #395 remains the earlier leftover-docs #393 snapshot.
  #393 remains the earlier leftover-docs #391 snapshot.
  #391 remains the earlier leftover-docs #389 snapshot.
  #389 remains the earlier leftover-docs #387 snapshot.
...
- **(a) Scope / 范围:** Status refresh after landing #456
  (extra-local int-copy as the fifth and sixth six-arg GregorianCalendar NEW initializer arguments). /
  落地 #456 之后的现状刷新。
