...
Last updated after extra-local int as the fourth five-arg GregorianCalendar `NEW` arg
[#362](https://github.com/gaoyu06/native-obfuscator/pull/362)
(parent XML 632; latest leftover inventory remains
[#361](https://github.com/gaoyu06/native-obfuscator/pull/361)
on post-[#360](https://github.com/gaoyu06/native-obfuscator/pull/360)
`7feb4c0`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR,
...
- Admit remaining IR leftovers so methods stop falling back:
  ...
  ([#361](https://github.com/gaoyu06/native-obfuscator/pull/361),
  measured on post-#360 `7feb4c0`) observed 0 leftovers; that is not
  coverage-complete. #359 remains the earlier post-#358 snapshot.
...
- **(a) Scope / 范围:** Status refresh after landing #362
  (extra-local int-copy as the fourth five-arg GregorianCalendar NEW initializer argument). /
  落地 #362 之后的现状刷新。
