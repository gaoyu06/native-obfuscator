...
Latest compiler parent XML remains #340 (599). Active process:
...
- **(a) Scope / 范围:** Status refresh after leftover inventory remasurement #341. /
  leftover inventory 重测 #341 之后的现状刷新。
