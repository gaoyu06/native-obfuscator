...
Latest compiler parent XML remains #330 (584). Active process:
...
- **(a) Scope / 范围:** Status refresh after leftover inventory remasurement #331. /
  leftover inventory 重测 #331 之后的现状刷新。
