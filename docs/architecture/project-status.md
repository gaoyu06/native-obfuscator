...
Last updated after extra-local int as second Insets `NEW` arg
[#330](https://github.com/gaoyu06/native-obfuscator/pull/330)
(parent XML 584; latest leftover inventory remains
[#329](https://github.com/gaoyu06/native-obfuscator/pull/329)
on post-[#328](https://github.com/gaoyu06/native-obfuscator/pull/328)
`b751add`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR,
...
- Admit remaining IR leftovers so methods stop falling back:
  ...
  ([#329](https://github.com/gaoyu06/native-obfuscator/pull/329),
  measured on post-#328 `b751add`) observed 0 leftovers; that is not
  coverage-complete. #327 remains the earlier post-#326 snapshot.
...
- **(a) Scope / 范围:** Status refresh after landing #330
  (extra-local int-copy as the second Insets NEW initializer argument). /
  落地 #330 之后的现状刷新。
