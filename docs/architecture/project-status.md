...
Last updated after extra-local two-arg `NEW` initializer
[#296](https://github.com/gaoyu06/native-obfuscator/pull/296)
(parent XML 517; latest leftover inventory remains
[#295](https://github.com/gaoyu06/native-obfuscator/pull/295)
on post-[#294](https://github.com/gaoyu06/native-obfuscator/pull/294)
`4459613`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR,
...
- Admit remaining IR leftovers so methods stop falling back:
  ...
  `NEW` initializer is admitted by #296 (fixture-only).
  ...
  ([#295](https://github.com/gaoyu06/native-obfuscator/pull/295),
  measured on post-#294 `4459613`) observed 0 leftovers; that is not
  coverage-complete. #292 remains the earlier post-#291 snapshot.
...
- **(a) Scope / 范围:** Status refresh after landing #296
  (extra-local int-copy as a two-arg NEW initializer). /
  落地 #296 之后的现状刷新。
