...
Latest compiler parent XML remains #346 (608). Active process:
...
- **(a) Scope / 范围:** Status refresh after leftover inventory remasurement #347. /
  leftover inventory 重测 #347 之后的现状刷新。
