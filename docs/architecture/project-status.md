...
Latest compiler parent XML remains #344 (605). Active process:
...
- **(a) Scope / 范围:** Status refresh after leftover inventory remasurement #345. /
  leftover inventory 重测 #345 之后的现状刷新。
