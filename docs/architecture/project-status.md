...
Last updated after extra-local int as first, second, and third Insets `NEW` args
[#350](https://github.com/gaoyu06/native-obfuscator/pull/350)
(parent XML 614; latest leftover inventory remains
[#349](https://github.com/gaoyu06/native-obfuscator/pull/349)
on post-[#348](https://github.com/gaoyu06/native-obfuscator/pull/348)
`94a4e0e`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR,
...
- Admit remaining IR leftovers so methods stop falling back:
  ...
  ([#349](https://github.com/gaoyu06/native-obfuscator/pull/349),
  measured on post-#348 `94a4e0e`) observed 0 leftovers; that is not
  coverage-complete. #347 remains the earlier post-#346 snapshot.
...
- **(a) Scope / 范围:** Status refresh after landing #350
  (extra-local int-copy as the first, second, and third Insets NEW initializer arguments). /
  落地 #350 之后的现状刷新。
