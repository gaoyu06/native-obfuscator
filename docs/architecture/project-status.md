...
Last updated after extra-local float `NEW` initializer
[#308](https://github.com/gaoyu06/native-obfuscator/pull/308)
(parent XML 542; latest leftover inventory remains
...
- **(a) Scope / 范围:** Status refresh after landing #308
  (extra-local float-copy as a NEW initializer). /
  落地 #308 之后的现状刷新。
