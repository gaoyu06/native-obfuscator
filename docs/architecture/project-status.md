...
Last updated after extra-local int as first and second Color `NEW` args
[#324](https://github.com/gaoyu06/native-obfuscator/pull/324)
(parent XML 575; latest leftover inventory remains
[#323](https://github.com/gaoyu06/native-obfuscator/pull/323)
on post-[#322](https://github.com/gaoyu06/native-obfuscator/pull/322)
`ae1b8da`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR,
...
- Admit remaining IR leftovers so methods stop falling back:
  ...
  ([#323](https://github.com/gaoyu06/native-obfuscator/pull/323),
  measured on post-#322 `ae1b8da`) observed 0 leftovers; that is not
  coverage-complete. #321 remains the earlier post-#320 snapshot.
...
- **(a) Scope / 范围:** Status refresh after landing #324
  (extra-local int-copy as first and second Color NEW initializer arguments). /
  落地 #324 之后的现状刷新。
