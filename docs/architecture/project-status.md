...
Last updated after extra-local int as the first and fourth six-arg GregorianCalendar `NEW` args
[#434](https://github.com/gaoyu06/native-obfuscator/pull/434)
(parent XML 740; latest leftover inventory remains
[#433](https://github.com/gaoyu06/native-obfuscator/pull/433)
on leftover-docs
[#432](https://github.com/gaoyu06/native-obfuscator/pull/432)
`ce634292`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR,
...
- Admit remaining IR leftovers so methods stop falling back:
  ...
  ([#433](https://github.com/gaoyu06/native-obfuscator/pull/433),
  measured on leftover-docs #432 `ce634292`) observed 0 leftovers; that is not
  coverage-complete. #432 remains the earlier leftover-docs #430 snapshot.
...
- **(a) Scope / 范围:** Status refresh after landing #434
  (extra-local int-copy as the first and fourth six-arg GregorianCalendar NEW initializer arguments). /
  落地 #434 之后的现状刷新。
