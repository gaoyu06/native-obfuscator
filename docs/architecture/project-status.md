...
Last updated after extra-local int as the second and sixth six-arg GregorianCalendar `NEW` args
[#446](https://github.com/gaoyu06/native-obfuscator/pull/446)
(parent XML 758; latest leftover inventory remains
[#445](https://github.com/gaoyu06/native-obfuscator/pull/445)
on leftover-docs
[#444](https://github.com/gaoyu06/native-obfuscator/pull/444)
`c89015d2`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR,
...
- Admit remaining IR leftovers so methods stop falling back:
  ...
  ([#445](https://github.com/gaoyu06/native-obfuscator/pull/445),
  measured on leftover-docs #444 `c89015d2`) observed 0 leftovers; that is not
  coverage-complete. #444 remains the earlier leftover-docs #442 snapshot.
...
- **(a) Scope / 范围:** Status refresh after landing #446
  (extra-local int-copy as the second and sixth six-arg GregorianCalendar NEW initializer arguments). /
  落地 #446 之后的现状刷新。
