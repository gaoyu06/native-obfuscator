...
Last updated after extra-local int as the second, third, and fourth five-arg GregorianCalendar `NEW` args
[#398](https://github.com/gaoyu06/native-obfuscator/pull/398)
(parent XML 689; latest leftover inventory remains
[#397](https://github.com/gaoyu06/native-obfuscator/pull/397)
on leftover-docs
[#395](https://github.com/gaoyu06/native-obfuscator/pull/395)
`38c8cf0`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR,
...
- Admit remaining IR leftovers so methods stop falling back:
  ...
  ([#397](https://github.com/gaoyu06/native-obfuscator/pull/397),
  measured on leftover-docs #395 `38c8cf0`) observed 0 leftovers; that is not
  coverage-complete. #395 remains the earlier leftover-docs #393 snapshot.
...
- **(a) Scope / 范围:** Status refresh after landing #398
  (extra-local int-copy as the second, third, and fourth five-arg GregorianCalendar NEW initializer arguments). /
  落地 #398 之后的现状刷新。
