...
Last updated after extra-local int as fourth Insets `NEW` arg
[#334](https://github.com/gaoyu06/native-obfuscator/pull/334)
(parent XML 590; latest leftover inventory remains
[#333](https://github.com/gaoyu06/native-obfuscator/pull/333)
on post-[#332](https://github.com/gaoyu06/native-obfuscator/pull/332)
`c4b6461`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR,
...
- Admit remaining IR leftovers so methods stop falling back:
  ...
  ([#333](https://github.com/gaoyu06/native-obfuscator/pull/333),
  measured on post-#332 `c4b6461`) observed 0 leftovers; that is not
  coverage-complete. #331 remains the earlier post-#330 snapshot.
...
- **(a) Scope / 范围:** Status refresh after landing #334
  (extra-local int-copy as the fourth Insets NEW initializer argument). /
  落地 #334 之后的现状刷新。
