...
Last updated after extra-local long `NEW` initializer
[#307](https://github.com/gaoyu06/native-obfuscator/pull/307)
(parent XML 539; latest leftover inventory remains
...
- **(a) Scope / 范围:** Status refresh after landing #307
  (extra-local long-copy as a NEW initializer). /
  落地 #307 之后的现状刷新。
