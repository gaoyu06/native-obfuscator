...
Last updated after extra-local int as first, third, and fourth Insets `NEW` args
[#354](https://github.com/gaoyu06/native-obfuscator/pull/354)
(parent XML 620; latest leftover inventory remains
[#353](https://github.com/gaoyu06/native-obfuscator/pull/353)
on post-[#352](https://github.com/gaoyu06/native-obfuscator/pull/352)
`764ecf5`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR,
...
- Admit remaining IR leftovers so methods stop falling back:
  ...
  ([#353](https://github.com/gaoyu06/native-obfuscator/pull/353),
  measured on post-#352 `764ecf5`) observed 0 leftovers; that is not
  coverage-complete. #351 remains the earlier post-#350 snapshot.
...
- **(a) Scope / 范围:** Status refresh after landing #354
  (extra-local int-copy as the first, third, and fourth Insets NEW initializer arguments). /
  落地 #354 之后的现状刷新。
