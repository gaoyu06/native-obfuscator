...
Last updated after extra-local int as the first and third six-arg GregorianCalendar `NEW` args
[#432](https://github.com/gaoyu06/native-obfuscator/pull/432)
(parent XML 737; latest leftover inventory remains
[#431](https://github.com/gaoyu06/native-obfuscator/pull/431)
on leftover-docs
[#430](https://github.com/gaoyu06/native-obfuscator/pull/430)
`46a53713`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR,
...
- Admit remaining IR leftovers so methods stop falling back:
  ...
  ([#431](https://github.com/gaoyu06/native-obfuscator/pull/431),
  measured on leftover-docs #430 `46a53713`) observed 0 leftovers; that is not
  coverage-complete. #430 remains the earlier leftover-docs #427 snapshot.
...
- **(a) Scope / 范围:** Status refresh after landing #432
  (extra-local int-copy as the first and third six-arg GregorianCalendar NEW initializer arguments). /
  落地 #432 之后的现状刷新。
