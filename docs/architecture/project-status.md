...
Last updated after extra-local three-arg `NEW` initializer
[#298](https://github.com/gaoyu06/native-obfuscator/pull/298)
(parent XML 520; latest leftover inventory remains
...
- **(a) Scope / 范围:** Status refresh after landing #298
  (extra-local int-copy as a three-arg NEW initializer). /
  落地 #298 之后的现状刷新。
