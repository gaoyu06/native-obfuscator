...
Last updated after extra-local int as third Insets `NEW` arg
[#332](https://github.com/gaoyu06/native-obfuscator/pull/332)
(parent XML 587; latest leftover inventory remains
[#331](https://github.com/gaoyu06/native-obfuscator/pull/331)
on post-[#330](https://github.com/gaoyu06/native-obfuscator/pull/330)
`753c401`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR,
...
- Admit remaining IR leftovers so methods stop falling back:
  ...
  ([#331](https://github.com/gaoyu06/native-obfuscator/pull/331),
  measured on post-#330 `753c401`) observed 0 leftovers; that is not
  coverage-complete. #329 remains the earlier post-#328 snapshot.
...
- **(a) Scope / 范围:** Status refresh after landing #332
  (extra-local int-copy as the third Insets NEW initializer argument). /
  落地 #332 之后的现状刷新。
