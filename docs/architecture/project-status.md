...
Latest compiler parent XML remains #328 (581). Active process:
...
- **(a) Scope / 范围:** Status refresh after leftover inventory remasurement #329. /
  leftover inventory 重测 #329 之后的现状刷新。
