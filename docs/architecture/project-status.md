...
Latest compiler parent XML remains #334 (590). Active process:
...
- **(a) Scope / 范围:** Status refresh after leftover inventory remasurement #335. /
  leftover inventory 重测 #335 之后的现状刷新。
