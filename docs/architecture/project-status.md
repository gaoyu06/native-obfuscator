...
Last updated after extra-local int as the first and sixth six-arg GregorianCalendar `NEW` args
[#438](https://github.com/gaoyu06/native-obfuscator/pull/438)
(parent XML 746; latest leftover inventory remains
[#437](https://github.com/gaoyu06/native-obfuscator/pull/437)
on leftover-docs
[#436](https://github.com/gaoyu06/native-obfuscator/pull/436)
`4fed275e`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR,
...
- Admit remaining IR leftovers so methods stop falling back:
  ...
  ([#437](https://github.com/gaoyu06/native-obfuscator/pull/437),
  measured on leftover-docs #436 `4fed275e`) observed 0 leftovers; that is not
  coverage-complete. #436 remains the earlier leftover-docs #434 snapshot.
...
- **(a) Scope / 范围:** Status refresh after landing #438
  (extra-local int-copy as the first and sixth six-arg GregorianCalendar NEW initializer arguments). /
  落地 #438 之后的现状刷新。
