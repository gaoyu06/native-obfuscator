...
Last updated after extra-local int as the third five-arg GregorianCalendar `NEW` arg
[#360](https://github.com/gaoyu06/native-obfuscator/pull/360)
(parent XML 629; latest leftover inventory remains
[#359](https://github.com/gaoyu06/native-obfuscator/pull/359)
on post-[#358](https://github.com/gaoyu06/native-obfuscator/pull/358)
`49b2e8c`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR,
...
- Admit remaining IR leftovers so methods stop falling back:
  ...
  ([#359](https://github.com/gaoyu06/native-obfuscator/pull/359),
  measured on post-#358 `49b2e8c`) observed 0 leftovers; that is not
  coverage-complete. #357 remains the earlier post-#356 snapshot.
...
- **(a) Scope / 范围:** Status refresh after landing #360
  (extra-local int-copy as the third five-arg GregorianCalendar NEW initializer argument). /
  落地 #360 之后的现状刷新。
