...
Latest compiler parent XML remains #338 (596). Active process:
...
- **(a) Scope / 范围:** Status refresh after leftover inventory remasurement #339. /
  leftover inventory 重测 #339 之后的现状刷新。
