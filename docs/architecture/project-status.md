...
Last updated after extra-local int as all six six-arg GregorianCalendar `NEW` args
[#427](https://github.com/gaoyu06/native-obfuscator/pull/427)
(parent XML 731; latest leftover inventory remains
[#426](https://github.com/gaoyu06/native-obfuscator/pull/426)
on leftover-docs
[#425](https://github.com/gaoyu06/native-obfuscator/pull/425)
`a54d9a28`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR,
...
- Admit remaining IR leftovers so methods stop falling back:
  ...
  ([#426](https://github.com/gaoyu06/native-obfuscator/pull/426),
  measured on leftover-docs #425 `a54d9a28`) observed 0 leftovers; that is not
  coverage-complete. #425 remains the earlier leftover-docs #423 snapshot.
...
- **(a) Scope / 范围:** Status refresh after landing #427
  (extra-local int-copy as all six six-arg GregorianCalendar NEW initializer arguments). /
  落地 #427 之后的现状刷新。
