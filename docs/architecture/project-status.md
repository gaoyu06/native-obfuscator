...
Last updated after extra-local int as the fourth six-arg GregorianCalendar `NEW` args
[#421](https://github.com/gaoyu06/native-obfuscator/pull/421)
(parent XML 722; latest leftover inventory remains
[#420](https://github.com/gaoyu06/native-obfuscator/pull/420)
on leftover-docs
[#419](https://github.com/gaoyu06/native-obfuscator/pull/419)
`82ee119a`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR,
...
- Admit remaining IR leftovers so methods stop falling back:
  ...
  ([#420](https://github.com/gaoyu06/native-obfuscator/pull/420),
  measured on leftover-docs #419 `82ee119a`) observed 0 leftovers; that is not
  coverage-complete. #419 remains the earlier leftover-docs #417 snapshot.
...
- **(a) Scope / 范围:** Status refresh after landing #421
  (extra-local int-copy as the fourth six-arg GregorianCalendar NEW initializer argument). /
  落地 #421 之后的现状刷新。
