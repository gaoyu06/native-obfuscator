...
`357d30e1`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR,
...
- Admit remaining IR leftovers so methods stop falling back:
  ...
  ([#412](https://github.com/gaoyu06/native-obfuscator/pull/412),
  measured on leftover-docs #411 `357d30e1`) observed 0 leftovers; that is not
  coverage-complete. #411 remains the earlier leftover-docs #409 snapshot.
