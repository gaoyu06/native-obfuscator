...
Last updated after extra-local int as first and third Insets `NEW` args
[#340](https://github.com/gaoyu06/native-obfuscator/pull/340)
(parent XML 599; latest leftover inventory remains
[#339](https://github.com/gaoyu06/native-obfuscator/pull/339)
on post-[#338](https://github.com/gaoyu06/native-obfuscator/pull/338)
`f7446f5`: ClassicTest 108/108, JDK 17/21/25 82/82, 47/47, 21/21 IR,
...
- Admit remaining IR leftovers so methods stop falling back:
  ...
  ([#339](https://github.com/gaoyu06/native-obfuscator/pull/339),
  measured on post-#338 `f7446f5`) observed 0 leftovers; that is not
  coverage-complete. #337 remains the earlier post-#336 snapshot.
...
- **(a) Scope / 范围:** Status refresh after landing #340
  (extra-local int-copy as the first and third Insets NEW initializer arguments). /
  落地 #340 之后的现状刷新。
