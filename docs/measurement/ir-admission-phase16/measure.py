#!/usr/bin/env python3
"""Reproduce phase-16 IR admission measurements without changing compiler code."""
...
REQUIRED_TIP = "dbfeb7816986ba886eb14e20c092f4f8f833a629"
...
def main() -> int:
    ...
    parser.add_argument(
        "--work-dir",
        type=Path,
        default=Path("/tmp/native-obfuscator-ir-admission-phase16"),
    )
    parser.add_argument(
        "--include-jdk21",
        action="store_true",
    ...
    try:
        ...
        if base != REQUIRED_TIP:
            raise RuntimeError(
                f"expected phase-16 base {REQUIRED_TIP}, found merge-base {base}"
            )
